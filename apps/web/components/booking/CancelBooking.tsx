...
export default function CancelBooking(props: Props) {
  ...
  const handleCancel = async (reasonOverride?: string) => {
    const reason = reasonOverride !== undefined ? reasonOverride : cancellationReason;
    try {
      setLoading(true);
        ...
        <div className={classNames(isRenderedAsCancelDialog ? "-mt-2 mb-8" : "mt-5 sm:mt-6")}>
          ...
          <div className="flex flex-col-reverse rtl:space-x-reverse ">
            <div
              ...
              {isRenderedAsCancelDialog ? (
                // Admin panel: both buttons cancel — one without reason, one with
                <>
                  <Button
                    className="ml-auto"
                    color="secondary"
                ...
                // Public / single-view: original behavior (reason may be required by event type)
                <>
                  <Button
                    className="ml-auto"
                    color="secondary"
