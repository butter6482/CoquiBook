...
export const WEBSITE_URL = ensureProtocol(process.env.NEXT_PUBLIC_WEBSITE_URL) || "https://coquibook.app";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "CoquíBook";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@coquibook.app";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "CoquíBook";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "CoquíBook";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "CoquíBook";
...
export const DEFAULT_LIGHT_BRAND_COLOR = "#1d7d45";
export const DEFAULT_DARK_BRAND_COLOR = "#4ade80";
